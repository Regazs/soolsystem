...
client.on('message', msg => {  
    if (msg.content === 'MahmoudiTech') {  
      msg.reply('**ايوا معاك يا برو**');  
    }
  });
...
client.login('OTg1MDg1MTk3NzczMDY2MjQw.GJzdBH.twuoP9sb_huK_MB7J44pdRcGZC8fH6h8_EjlYQ'); 
